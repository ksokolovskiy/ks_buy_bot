...
# Sharing messages
MSG_SHARE_INFO = """
🔗 *Общий доступ к списку*

Чтобы другой пользователь мог видеть и редактировать ваш список, он должен отправить боту этот код:

`{}`

*(Нажмите на код, чтобы скопировать)*

Или просто пришлите ему команду:
`/join {}`
"""
...
Вы собираетесь присоединиться к чужому списку. Ваши текущие товары и категории будут заменены на товары из нового списка.

Вы уверены?
"""

MSG_JOIN_SUCCESS = "✅ Вы успешно присоединились к новому списку!"
MSG_JOIN_ERROR = "❌ Ошибка: неверный код приглашения."
